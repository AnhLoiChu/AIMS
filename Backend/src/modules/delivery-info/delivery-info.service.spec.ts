...
describe('DeliveryInfoService', () => {
  ...
  describe('createRushOrderDeliveryInfo', () => {
    const mockCustomerRole: Role = {
      role_id: 1,
      name: RoleName.CUSTOMER,
    };
    ...
    const validRushDeliveryDto: CreateDeliveryInfoDto = {
      recipient_name: 'John Doe',
      email: 'john@example.com',
      phone: '0123456789',
      province: 'HN',
    ...
    describe('Success Scenarios', () => {
      it('should create rush order delivery info successfully', async () => {
        deliveryInfoRepository.create.mockReturnValue(mockDeliveryInfo);
        deliveryInfoRepository.save.mockResolvedValue(mockDeliveryInfo);

        const result =
          await service.createRushOrderDeliveryInfo(validRushDeliveryDto);

        expect(deliveryInfoRepository.create).toHaveBeenCalledWith(
          validRushDeliveryDto,
        );
        expect(deliveryInfoRepository.save).toHaveBeenCalledWith(
          mockDeliveryInfo,
        );
    ...
    describe('Validation Scenarios', () => {
      it('should throw BadRequestException if recipient_name is missing', async () => {
        ...
        await expect(
          service.createRushOrderDeliveryInfo(dtoWithoutRecipientName),
      ...
      it('should throw BadRequestException if email is missing', async () => {
        ...
        await expect(
          service.createRushOrderDeliveryInfo(dtoWithoutEmail),
        ).rejects.toThrow(BadRequestException);
      ...
      it('should throw BadRequestException if phone is missing', async () => {
        ...
        await expect(
          service.createRushOrderDeliveryInfo(dtoWithoutPhone),
        ).rejects.toThrow(BadRequestException);
      ...
      it('should throw BadRequestException if province is missing', async () => {
        ...
        await expect(
          service.createRushOrderDeliveryInfo(dtoWithoutProvince),
        ).rejects.toThrow(BadRequestException);
      ...
      it('should throw BadRequestException if address is missing', async () => {
        ...
        await expect(
          service.createRushOrderDeliveryInfo(dtoWithoutAddress),
        ).rejects.toThrow(BadRequestException);
      ...
      it('should throw BadRequestException if instruction is missing', async () => {
        const dtoWithoutInstruction = {
          ...validRushDeliveryDto,
          instruction: null,
        };

        await expect(
          service.createRushOrderDeliveryInfo(dtoWithoutInstruction),
        ).rejects.toThrow(BadRequestException);
      ...
      it('should throw BadRequestException if delivery_time is missing', async () => {
        const dtoWithoutDeliveryTime = {
          ...validRushDeliveryDto,
          delivery_time: null,
        };

        await expect(
          service.createRushOrderDeliveryInfo(dtoWithoutDeliveryTime),
        ).rejects.toThrow(BadRequestException);
      ...
      it('should throw BadRequestException if province is not HN', async () => {
        const dtoWithNonHanoiProvince = {
          ...validRushDeliveryDto,
          province: 'HCM',
        };

        await expect(
          service.createRushOrderDeliveryInfo(dtoWithNonHanoiProvince),
        ).rejects.toThrow(BadRequestException);
